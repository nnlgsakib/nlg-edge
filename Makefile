...
build: check-go check-git
	...
	go build -o polygon-edge -ldflags="\
    	-X 'github.com/nnlgsakib/neth/versioning.Version=$(LATEST_VERSION)' \
		-X 'github.com/nnlgsakib/neth/versioning.Commit=$(COMMIT_HASH)'\
		-X 'github.com/nnlgsakib/neth/versioning.Branch=$(BRANCH)'\
		-X 'github.com/nnlgsakib/neth/versioning.BuildTime=$(TIME)'" \
	main.go
